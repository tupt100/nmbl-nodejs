...
export class CustomTemplateWorkflowService {
  ...
  createWorkflowTemplate(data?): Observable<any> {
    ...
    return this.http.post<IBaseResponse<any>>(`${API_BASE_URL}projects/api/workflow-templates/`, template);
  }
  ...
  removeWorkflowTemplate(id?): Observable<any> {
    return this.http.delete<IBaseResponse<any>>(
      `${API_BASE_URL}projects/api/workflow-templates/${id}`)
  }
  ...
  updateWorkflowTemplate(data, id): Observable<any> {
    const template = new CustomWorkflowTemplateOutputModel(data);
    return this.http.put<IBaseResponse<any>>(`${API_BASE_URL}projects/api/workflow-templates/${id}/`, template);
  }
  ...
  createCustomField(data): Observable<any> {
    ...
    return this.http.post<IBaseResponse<any>>(`${API_BASE_URL}projects/api/workflow-templates-custom-fields/`, field);
  }
  ...
  updateCustomField(data, id): Observable<any> {
    const field = new CustomFieldOutputModel(data);
    return this.http.put<IBaseResponse<any>>(`${API_BASE_URL}projects/api/workflow-templates-custom-fields/${id}/`, field);
  }
  ...
  getWorkflowTemplateCustomFields(id: number): Observable<any> {
    return this.http.get<IBaseResponse<any>>(`${API_BASE_URL}projects/api/workflow-templates-custom-fields?workflow_template_id=${id}`);
  }
  ...
  getCustomWorkflowTemplates(data): Observable<any> {
    return this.http.get<IBaseResponse<any>>(`${API_BASE_URL}projects/api/workflow-templates/`, { params: data });
  }
  ...
  getCustomWorkflowTemplateDetails(id: number): Observable<any> {
    return this.http.get<IBaseResponse<any>>(`${API_BASE_URL}projects/api/workflow-templates/${id}/`);
  }
  ...
  removeCustomField(data: CustomField, taskTemplateId): Observable<any> {
    const field = new CustomFieldOutputModel(data);
    return this.http.delete<IBaseResponse<any>>(
      `${API_BASE_URL}projects/api/workflow-templates-custom-fields/${field.pk}/`)
  }
  ...
  createTask(data): Observable<any> {
    return this.http.post<IBaseResponse<any>>(`${API_BASE_URL}projects/api/task-fixtures/`, data);
  }

  getTask(id): Observable<any> {
    return this.http.get<IBaseResponse<any>>(`${API_BASE_URL}projects/api/task-fixtures/${id}`);
  }

  removeTask(id): Observable<any> {
    return this.http.delete<IBaseResponse<any>>(
      `${API_BASE_URL}projects/api/task-fixtures/${id}/`)
  }

  updateTask(data, id): Observable<any> {
    return this.http.put<IBaseResponse<any>>(`${API_BASE_URL}projects/api/task-fixtures/${id}/`, data);
  }
