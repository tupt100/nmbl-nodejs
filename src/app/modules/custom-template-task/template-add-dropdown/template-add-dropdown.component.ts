...
@Component({
  selector: 'app-template-add-dropdown',
  templateUrl: './template-add-dropdown.component.html',
  styleUrls: ['./template-add-dropdown.component.scss']
})
export class TemplateAddDropdownComponent implements OnInit, OnDestroy {
  templates = [];
  loading: boolean;
  searchText: String;
  timer: any;
  ...
  private objFeatures$;
  @Output() addNewTaskTemplate: EventEmitter<void> = new EventEmitter();
  constructor(
